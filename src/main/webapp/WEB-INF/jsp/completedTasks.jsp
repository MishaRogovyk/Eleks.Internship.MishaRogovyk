...
<h1 align="center">Completed tasks</h1><br/>
...
<table id="myTable">
    ...
    <c:forEach var = "tasks" items = "${taskCompleted}">
        <tr>
            <td>${tasks.id}</td>
            ...
            <td><a href="/deleteCompleted/${tasks.id}"><button class="glyphicon glyphicon-trash"></button></a></td>
        </tr>
    </c:forEach>
